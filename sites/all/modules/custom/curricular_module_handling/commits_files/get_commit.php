...
$response = $api->get('repos/software-enterprise-asu/'.$repo.'/'.'commits/'.$sha);
	...
	<div class="full-commit ">
	  ...
	  <div class="commit-meta clearfix">
	    <span class="float-right">
	      <span class="sha-block">commit <span class="sha user-select-contain"><?php echo $my_commit->sha;?></span></span>
	    </span>
